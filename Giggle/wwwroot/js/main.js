document.addEventListener('DOMContentLoaded', () => {
  ...
  /* Init swiper slider with 3 slides  in desktop  */
  // new Swiper('.slides-3', {
  //   speed: 600,
  //   loop: true,
  //   centeredSlides: true,
  ...
  function opensigninPopup(signinPageUrl, Title) {
    var popupWidth = 400;
    var popupHeight = 800;
    var popupOptions = 'width=' + popupWidth + ',height=' + popupHeight + ',resizable=yes,scrollbars=yes';
    window.open(signinPageUrl, Title, popupOptions);
  }
